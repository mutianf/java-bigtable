 ...
 */
class BuiltinMetricsTracer1 extends BigtableTracer {
    ...
    private void recordAttemptCompletion(@Nullable Throwable status) {
        ...
        double clientBlockingTemp = totalClientBlockingTime.getAndSet(0) * 1e-6;
        recorder.putClientBlockingLatencies((long) clientBlockingTemp);
